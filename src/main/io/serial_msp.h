...
#define MSP_MAX_OSD              127    //out message         getthe osd config
...
#define MSP_SET_MAX_OSD          221    //in message          set the osd config
#define MSP_SET_MAX_OSD_FONT     222    //in message          set the osd font
